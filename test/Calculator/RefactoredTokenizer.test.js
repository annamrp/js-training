...
test("tokenizer recives a single number and returns a value token", () => {
  expect(tokenizer("5")).toEqual({ value: 5, type: "value" });
  expect(tokenizer("8")).toEqual({ value: 8, type: "value" });
});
...
test("tokenizer recives a mult and sum of numbers and returns a token", () => {
  expect(tokenizer("5*5+3")).toEqual({
    type: "sum",
    value1: {
      type: "mult",
      value1: { value: 5, type: "value" },
...
test("tokenizer recives a div and a rest of numbers and returns a token", () => {
  expect(tokenizer("6/2-3")).toEqual({
    type: "rest",
    value1: {
      type: "div",
      value1: { value: 6, type: "value" },
...
test("tokenizer recives a sum and a div of numbers and returns a token", () => {
  expect(tokenizer("3+6/2")).toEqual({
    type: "sum",
...
test("tokenizer recives a div of 3 numbers and returns a token", () => {
  expect(tokenizer("12/3/2")).toEqual({
    type: "div",
    value1: {
      type: "div",
...
test("runs the program", () => {
  const result = evaluator(tokenizer("55+25-75"));

  expect(result).toBe(5);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("50+25+75"));

  expect(result).toBe(150);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("5*5*5"));
...
test("runs the program", () => {
  const result = evaluator(tokenizer("5*5+3-1"));

  expect(result).toBe(27);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("12/3/2"));

  expect(result).toBe(2);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("5+10/2"));
...
test("runs the program", () => {
  const result = evaluator(tokenizer("30/7-2"));

  expect(result).toBe(2.29);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("30/3/2"));

  expect(result).toBe(5);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("2.2+2.1"));

  expect(result).toBe(4.3);
});

test("runs the program", () => {
  const result = evaluator(tokenizer("2.201-2.101"));
